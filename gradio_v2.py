...
- generate_images_from_story(image_file, story_text): Generates images based on the story and image via cv2 and stable diffusion, returning the paths of the generated images and the summarized prompts.
...
def generate_story_prompts(story_text):
    ...
    try:
        ...
        structured_prompt = (
            f"{story_text}\n\n"
            "Summarize and break this story about a scientist flow-wise and these sentences will be used as image generation prompts. EXACTLY 4 SENTENCES. \n\n"
            "All sentences must be structured in ONE PARAGRAPH. Each sentence should have a maximum of 10 words and must be simple and scientific.\n\n"
